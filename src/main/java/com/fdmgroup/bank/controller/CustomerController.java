...
@CrossOrigin(origins = "http://lucas-bank-frontend-service:5000", allowedHeaders = "*")
public class CustomerController {
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Successfully retrieved customer", content = {
					@Content(mediaType = MediaType.APPLICATION_JSON_VALUE) }, headers = {
							@Header(name = "location", description = "URL of the retrieved customer") }),
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "201", description = "Successfully created customer", content = {
					@Content(mediaType = MediaType.APPLICATION_JSON_VALUE) }, headers = {
							@Header(name = "location", description = "URL of the created customer") }),
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Successfully updated customer", content = {
					@Content(mediaType = MediaType.APPLICATION_JSON_VALUE) }, headers = {
							@Header(name = "location", description = "URL of the updated customer") }),
			@ApiResponse(responseCode = "404", description = "Customer not found"),
			@ApiResponse(responseCode = "400", description = "Invalid input data"),
			@ApiResponse(responseCode = "500", description = "Internal server error")
	})
